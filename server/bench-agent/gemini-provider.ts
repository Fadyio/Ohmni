...
3. Causal Hypothesis: The stress-test result includes evidence_ids generated by that exact experiment. When it reproduces a brownout reset or voltage sag, immediately call propose_hypothesis and pass those exact evidence_ids. Never propose an evidence-free diagnosis when experiment evidence IDs are available.
